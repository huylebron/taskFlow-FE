              ...
              <Grid container spacing={2}>
                {boards.map(b => (
                  <Grid xs={2} sm={3} md={4} key={b._id}>
                    <Link to={`/boards/${b._id}`} style={{ textDecoration: 'none' }}>
                      <Card sx={{ width: '250px', cursor: 'pointer', '&:hover': { boxShadow: 6 } }}>
                        {/* Background preview */}
                        {b.backgroundType === 'image' && b.backgroundImage ? (
                          <Box 
                            sx={{ 
                              height: '100px', 
                          ...
                          <Box 
                            sx={{ 
                              height: '100px', 
                              backgroundColor: b.backgroundColor || randomColor() 
                            }}
                          />
                        )}
